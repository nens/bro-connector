        ...
        for i, row in enumerate(csv.iter_rows(named=True)):
            ...
            if tube_db is not None:
                for t in tube_db:
                    ...
                    t.save()
                    print(f'gelukt voor put {nitg_csv} met gw-lichaam {t.krw_body} en diepte {t.gwl_depth}')  

                    aanwezige_putten.append((t.groundwater_monitoring_tube_static_id, nitg_csv, tube_csv))   
