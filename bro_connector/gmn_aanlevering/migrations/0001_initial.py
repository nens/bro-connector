# Generated by Django 4.0.3 on 2023-11-09 15:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groundwater_monitoring_tube', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gmw_aanlevering.groundwatermonitoringtubesstatic')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gmn', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gmn_aanlevering.groundwatermonitoringnet')),
                ('measuring_point', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='gmn_aanlevering.measuringpoint')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measuringpoint', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='gmn_aanlevering.measuringpoint')),
            ],
            options={
