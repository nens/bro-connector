...
def import_xml(file: str, path: str) -> tuple:
    ...
    for tube_number in range(gmw.number_of_tubes):
        ...
        try:
            ...
            raise Exception(f"Failed while trying to create geo_ohm_cable or electrode objects, {gmw_dict}")
...
class InitializeData:
    ...
    def well(self):
        ...
        if construction_date is not None:
            construction_date = datetime.datetime.strptime(construction_date, "%Y-%m-%d")
        ...
        self.meetpunt_instance = bro.GroundwaterMonitoringWellStatic.objects.create(
            ...
            delivery_accountable_party = self.gmw_dict.get("deliveryAccountableParty", None),
    ...
    def well_dynamic(self):
        ...
        self.meetpuntgeschiedenis_instance = bro.GroundwaterMonitoringWellDynamic.objects.create(
    ...
    def filter(self):
        ...
        arthesisch_water_aanwezig = get_artesian_well_cap_present(self.gmw_dict, self.prefix)
    ...
    def filter_dynamic(self):
        self.filtergeschiedenis_instance = bro.GroundwaterMonitoringTubesDynamic.objects.create(
    ...
    def electrode_static(self):
        ...
        self.eles = bro.ElectrodeStatic.objects.create(
            ...
            elektrodepositie=self.gmw_dict.get(
