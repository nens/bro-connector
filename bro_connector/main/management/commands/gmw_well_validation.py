...
from gmw.bro_validators.well_validation import well_validation
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for well_static in well_static_query:
            well_validation_state = well_validation() # initialize the well validation state
            complete, actions = well_validation_state.well_stat_check(well_static)
